...
export default defineComponent({
  ...
  setup() {
    ...
    const onDelete = (record) => {
      axios.delete("/business/business/admin/sk-token/delete/" + record.id).then((response) => {
    ...
    const handleOk = () => {
      axios.post("/business/business/admin/sk-token/save", skToken.value).then((response) => {
    ...
    const handleQuery = (param) => {
      ...
      loading.value = true;
      axios.get("/business/business/admin/sk-token/query-list", {
        params: {
          page: param.page,
          size: param.size
        }
